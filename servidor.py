...
class Servidor:
    def __init__(self, host, port): 
        ...
        self.__TabelaHashSalas = ChainHashTable(100) # HashTableEncadeada que armazena as Salas criadas.
        self.__TabelaHashCliente = ChainHashTable1(100) # HashTableEncadeada que armazena conexões feitas.
            ...
            while True:
                ...
                if comando == 'CADASTRAR_USUARIO':  # Se o comando for "CADASTRAR"
                    ...
                    if resposta == '+104': #Cadastro realizado com sucesso
                        self.__fila_acoes.enfileira(f'{Fore.GREEN}Novo usuário cadastrado: {dado1}{Style.RESET_ALL}')  # Adicionando a ação na fila
